...
namespace JustR.MessageService
{
    ...
    public class MessageController : Controller
    {
        ...
        private readonly IRestClient _notificationClient =
            new RestClient(ServiceConfigurations.NotificationServiceUrl).UseNewtonsoftJson();
        ...
        public async Task<ActionResult<Message>> SendMessage([FromQuery] Guid userId, Guid dialogId, Guid receiverId,
